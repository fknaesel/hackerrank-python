...
# contains a leap day. In the Gregorian calendar, three conditions are used to
# identify leap years:
...
# Task: Given a year, determine whether it is a leap year. If it is a leap
